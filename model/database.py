...
class UsersDB(metaclass=MetaSingleton):
    ...
    def set_user(self, username: str, password: str, telephone_number: str,uuid: str) -> None:
    ...
    def check_user_data(self, username: str, password: str) -> tuple:
        query = "SELECT id FROM users WHERE username = %s AND password = %s"
        return self._execute_query(query, (username, password)).fetchone()
