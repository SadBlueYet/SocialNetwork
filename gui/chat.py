...
class Ui_Chat(object):
    def setupUi(self, Chat):
        ...
        Chat.setMaximumSize(QSize(250, 65))
...
"}")
        ...
        sizePolicy.setHeightForWidth(self.user_nick.sizePolicy().hasHeightForWidth())
        self.user_nick.setSizePolicy(sizePolicy)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.user_nick, 0, 2, 1, 4)
...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.new_mes.sizePolicy().hasHeightForWidth())
        self.new_mes.setSizePolicy(sizePolicy1)
...
"}")
    ...
    def retranslateUi(self, Chat):
        ...
        self.mes_text.setText(QCoreApplication.translate("Chat", u"\u0438\u0434\u0438 \u043d\u0430\u0445\u0443\u0439", None))
        self.user_nick.setText(QCoreApplication.translate("Chat", u"\u0441\u0430\u043d\u044f", None))
        self.new_mes.setText(QCoreApplication.translate("Chat", u" 99+ ", None))
    # retranslateUi
